<?php
  ...
  $sid = $_GET['update_id'];
  $sql = "Select * from `patients` where id = $sid";
  ...
  if(isset($_POST['submit'])){
      ...
      $mysql = "update `patients` set  name = '$name', email = '$email', pnumber = '$pnumber', blood_type = '$blood_type' where id =$sid";
...
<!-- Email input-->
 ...
 <!-- Phone Number input-->
  ...
  <!-- Blood Type input-->
      ...
      <button type="button" class="btn btn-primary btn-xl" > <a href="patientslist.php" class="text-ligth" style="text-decoration: none; color: white; font-style: italic;"><b>
         <b>Back</b></a>
