                        ...
                        <table class="table">
                            ...
                            <?php
                                ...
                                echo "<tr>
                                            ...
                                            <a href= 'deldonor.php?del_id=$id'><button class='btn btn-primary' type='button' value='button' > Delete</button></a>
                                            </td>
                                            <td>
                                             <a href='updonor.php?update_id=$id'><button class='btn btn-primary' type='button' value='button'>Update</button></a>
