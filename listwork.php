        ...
        <section class="page-section" id="list">
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <a href='searchwork.php?update_id=$id'><button class='btn btn-primary' type='button' value='button'>Search</button></a>
                        ...
                        <table class="table">
                            ...
                            <?php
                                ...
                                echo "<tr>
                                            ...
                                            <td>
                                             <a href='uplist.php?update_id=$id'><button class='btn btn-primary' type='button' value='button'>Update</button></a>
